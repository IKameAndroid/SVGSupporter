...
public class AnimationBuilder {
    ...
    public AnimationBuilder pathData(String... pathData) {
        ...
        if (!PathParserCompat.canMorph(pathDataNodes)) {
            Log.w("RichPathAnimator", "the paths aren't compatible for morphing. " +
                    "Độ dài pathdata phải bằng nhau mới chuyển được!!!");
            return this;
        }
    ...
    public AnimationBuilder rotation(float... values) {
        ...
        public AnimationBuilder rotationX(float... values) {
        property("rotationX", values);
        return this;
    }

    public AnimationBuilder rotationY(float... values) {
