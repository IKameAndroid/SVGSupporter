...
import com.example.svgsupporter.richpathanimator.AnimationListener;
import com.example.svgsupporter.richpathanimator.RichPathAnimator;

public class MainActivity extends AppCompatActivity {
    private SVGImageView loveFaceSVGImageView;
    private SVGImageView commandRichPathView;
    private SVGImageView androidRichPathView;
    private SVGImageView arrowSearchRichPathView;
    private SVGImageView notificationsRichPathView;
    private SVGImageView playlistAddCheckRichPathView;

    private SVGImageView animalRichPathView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        androidRichPathView = (SVGImageView) findViewById(R.id.ic_android);
        arrowSearchRichPathView = (SVGImageView) findViewById(R.id.arrow_search);
        notificationsRichPathView = (SVGImageView) findViewById(R.id.ic_notifications);
        playlistAddCheckRichPathView = (SVGImageView) findViewById(R.id.ic_check_playlist);
        commandRichPathView = (SVGImageView) findViewById(R.id.ic_command);
        animalRichPathView = (SVGImageView) findViewById(R.id.animal);
    ...
    public void animateAndroid(View view) {
        ...
        RichPathAnimator.animate(head, rEye, lEye, body, rHand, lHand)
                ...
                .fillColor(Color.BLACK, Color.YELLOW)
